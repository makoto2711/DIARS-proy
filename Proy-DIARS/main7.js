!function(d,w,c) 
{
    ...
    {
        const arr_registros = JSON.parse(localStorage.getItem("info")) || []
    ...
    function showItems(arr) 
    {
        ...
        localStorage.setItem("info", todoStrings)
        cleanTable() 
    ...
    window.addEventListener("click", e => 
    {
        ...
        {
            trucoB = true
            exampleModal.querySelector("#trickTitle").textContent = "Registrar Informe"
        ...
        if ( e.target.classList.contains("btn-warning") ) 
        {
                ...
                indice = e.target.id 
                exampleModal.querySelector("#trickTitle").textContent = "Editar Informe"
