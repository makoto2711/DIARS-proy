!function(d,w,c) 
{
    ...
    {
        const arr_registros = JSON.parse(localStorage.getItem("prove")) || []
        ...
        $formInicio.addEventListener("submit", (e)=> 
        {
            ...
            else
            {
               ...
               arr_registros[indice].cod_soli =       exampleModal.querySelector("#cod_soli").value
    ...
    function showItems(arr) 
    {
        ...
        localStorage.setItem("prove", todoStrings)
        cleanTable() 
        ...
        arr.forEach( (item,i) => 
        {
            ...
            clone.querySelector(".des").textContent =  item.cod_soli
            clone.querySelector(".cod_soli").textContent =  item.descripcion
    ...
    window.addEventListener("click", e => 
    {
        ...
        if ( e.target.classList.contains("btn-warning") ) 
        {
                ...
                exampleModal.querySelector("#cod_soli").value =             arr_registros[e.target.id].cod_soli
